...
WHERE (ud.name IS NULL) OR (ud.time < CURDATE());";
        ...
        $email = $row['email'];
            ...
            if ($email) {
                ...
                $email_data = [
                    ...
                    <p style="color: #333; font-size: 18px; line-height: 1.6; margin-bottom: 20px; text-align: left; padding: 10px; background-color: #f7f7f7; border-radius: 8px;">You Have Not Submitted Your Todays work.',
